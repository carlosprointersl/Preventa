...
var textPrice = Ti.UI.createTextField({
    width : '35%',
    keyboardType : Ti.UI.KEYBOARD_DECIMAL_PAD,
    value : global.Functions.numToEuro(article.Tarifa).slice(0, -1)
});
