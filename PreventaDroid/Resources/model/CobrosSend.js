/**
 * @fileOverview En este archivo se crea el modelo "CobrosSend" y se hereda de la clase "Persistence".
 *
 ...
 */
function CobrosSend() {
	Persistence.call(this, "Cobros", Global.ConfigDB.SEND_NAME, false);
	/**
	 * Código propio de este modelo
	 */
};

CobrosSend.prototype = Persistence;

module.exports = CobrosSend;
